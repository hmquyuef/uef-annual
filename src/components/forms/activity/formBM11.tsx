...
import { ImportSchoolLevels } from "@/services/generalWorks/schoolLevelServices";
    ...
    onDrop: useMemo(
      () => async (acceptedFiles: File[]) => {
        ...
        if (results && results !== undefined) {
          ...
          const response = await ImportSchoolLevels(formDataImport);
